...
module Ovh::Api
  module Api
    class License::Cpanel
      ...
      def service_name_put(service_name:, license_cpanel_cpanel:)
        raise ArgumentError, 'service_name is required' if service_name.nil?
        raise ArgumentError, 'license_cpanel_cpanel is required' if license_cpanel_cpanel.nil?
