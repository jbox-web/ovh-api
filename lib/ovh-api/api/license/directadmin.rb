...
module Ovh::Api
  module Api
    class License::Directadmin
      ...
      def service_name_change_os_post(service_name:, body:)
        raise ArgumentError, 'service_name is required' if service_name.nil?
        raise ArgumentError, 'body is required' if body.nil?
      ...
      def service_name_put(service_name:, license_directadmin_direct_admin:)
        raise ArgumentError, 'service_name is required' if service_name.nil?
        raise ArgumentError, 'license_directadmin_direct_admin is required' if license_directadmin_direct_admin.nil?
        ...
        @connection.call(
          ...
          type: nil,
          auth: [],
          body: license_directadmin_direct_admin
        )
      end
