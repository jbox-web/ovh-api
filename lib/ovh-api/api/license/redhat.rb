...
module Ovh::Api
  module Api
    class License::Redhat
      ...
      def service_name_put(service_name:, license_redhat_red_hat:)
        raise ArgumentError, 'service_name is required' if service_name.nil?
        raise ArgumentError, 'license_redhat_red_hat is required' if license_redhat_red_hat.nil?
