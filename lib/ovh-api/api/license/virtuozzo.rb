...
module Ovh::Api
  module Api
    class License::Virtuozzo
      ...
      def service_name_option_get(service_name:, label: nil)
        raise ArgumentError, 'service_name is required' if service_name.nil?
      ...
      def service_name_put(service_name:, license_virtuozzo_virtuozzo:)
        raise ArgumentError, 'service_name is required' if service_name.nil?
        raise ArgumentError, 'license_virtuozzo_virtuozzo is required' if license_virtuozzo_virtuozzo.nil?
        ...
        @connection.call(
          ...
          type: nil,
          auth: [],
          body: license_virtuozzo_virtuozzo
        )
      end
