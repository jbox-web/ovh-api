...
module Ovh::Api
  module Api
    class Services::Detach
      def initialize(connection)
        @connection = connection
      end

      def execute(plan_code:, service_id:, services_operation_detach_execution_request:)
        raise ArgumentError, 'plan_code is required' if plan_code.nil?
        raise ArgumentError, 'service_id is required' if service_id.nil?
        raise ArgumentError, 'services_operation_detach_execution_request is required' if services_operation_detach_execution_request.nil?
        ...
        @connection.call(
          ...
          type: nil,
          auth: [],
          body: services_operation_detach_execution_request
        )
      end
      ...
      def options(plan_code:, service_id:)
        raise ArgumentError, 'plan_code is required' if plan_code.nil?
        raise ArgumentError, 'service_id is required' if service_id.nil?
      ...
      def simulate(plan_code:, service_id:, services_operation_detach_execution_request:)
        raise ArgumentError, 'plan_code is required' if plan_code.nil?
        raise ArgumentError, 'service_id is required' if service_id.nil?
        raise ArgumentError, 'services_operation_detach_execution_request is required' if services_operation_detach_execution_request.nil?
