...
module Ovh::Api
  module Api
    class Telephony::Redirect
      def initialize(connection)
        @connection = connection
      end

      def change_destination(billing_account:, service_name:, body:)
      ...
      def update(billing_account:, service_name:, telephony_redirect:)
        raise ArgumentError, 'billing_account is required' if billing_account.nil?
        raise ArgumentError, 'service_name is required' if service_name.nil?
        raise ArgumentError, 'telephony_redirect is required' if telephony_redirect.nil?
